...
def build():
    ...
    out.append(descriptor("uao-09f5f6b2f9fd", "Stafford Beer", 1990, [1990, 1990], "four monochrome frames from one 1990 lecture session (University of St. Gallen archive)", BA, {
        ...
        "eyewear": {"present": F("glasses", "high", B2 + B3, e), "lens_shape": F("round", "high", B2, e, "small lenses"), "frame": F("metal", "high", B2, e), "frame_colour": U(e, "monochrome"), "worn": F("low_on_nose", "high", B2 + B3, e, "looks over them; a second pair hangs at the chest on a cord")},
        ...
        "accessories": [acc("spectacles on a cord", BA, position="chest", habitual=None, conf="high")], "props": [{"item": "sheets of paper (held)", "evidence": B1 + B2}, {"item": "pen or cigarette (right hand)", "evidence": B3}, {"item": "chalkboard (in frame)", "evidence": B3 + B4}]},
        d["notEvidenced"] + ["jaw, mouth (hidden)", "eyewear frame colour"], d))
