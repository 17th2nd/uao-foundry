...
def build():
    ...
    out.append(descriptor("uao-09f5f6b2f9fd", "Stafford Beer", 1990, [1990, 1990], "four monochrome frames from one 1990 lecture session (University of St. Gallen archive)", BA, {
        ...
        "eyewear": {"present": F("unknown", "high", [], e, "MONOCLE (no enumeration value): a single round lens worn in the right eye on a cord; not spectacles — founder correction 2026-09-05"), "lens_shape": F("round", "high", B2 + B1, e, "single lens, right eye"), "frame": F("metal", "high", B2, e, "monocle rim"), "frame_colour": U(e, "monochrome"), "worn": F("unknown", "high", [], e, "monocle sits low against the cheek; he looks over it")},
        ...
        "accessories": [acc("monocle on a cord (right eye)", B1 + B2 + B3, position="right eye; cord to the chest", habitual=None, conf="high")], "props": [{"item": "sheets of paper (held)", "evidence": B1 + B2}, {"item": "pen or cigarette (right hand)", "evidence": B3}, {"item": "chalkboard (in frame)", "evidence": B3 + B4}]},
